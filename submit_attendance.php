...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Check if 'division_hidden', 'subject', and 'roll_no' are set in the POST request
    if (isset($_POST['division_hidden']) && isset($_POST['subject']) && isset($_POST['roll_no'])) {
        ...
        foreach ($roll_numbers as $roll_no) {
            ...
            $stmt->bind_param("issss", $roll_no, $division, $attendance_date, $attendance_status, $subject);
            if ($stmt->execute()) {
        ...
        echo "Error: Division, subject, or roll numbers not provided.";
    }
}
